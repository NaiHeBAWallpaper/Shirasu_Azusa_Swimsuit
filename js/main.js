...
let customScale = 1;
let targetFps = 60;
let bgmfile = './assets/audio/Luminous Memory.flac';
let bgmvolume = 0;
let bgm;
...
const CHARACTER = 'Azusa_swimsuit';
...
const AUDIO_DETAIL = [
	...
	},
	{
		...
		dialog: {
			...
			English: [
				"Because right now...",
				"...I have Sensei in my sights."
			],
			Chinese: [
				"可能是因为，现在我目所能及的地方，一直都能看见……",
				"……老师的存在吧。"
			]
		}
	}
...
const HITBOX = {
	headpat: { xMin: 1300, xMax: 1900, yMin: -150, yMax: 250 },
	voiceline: { xMin: 1350, xMax: 1880, yMin: 700, yMax: 1500 }
};
